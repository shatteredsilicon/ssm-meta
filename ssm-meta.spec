...
Requires: ssm-qan-api = 9.4.2
Requires: ssm-qan-app = 9.4.2
Requires: percona-toolkit = 3.7.0
Requires: ssm-dashboards = 9.4.6
Requires: ssm-server = 9.4.3
Requires: ssm-client = 9.4.4
Requires: ssm-manage = 9.4.1
Requires: ssm-managed = 9.4.3
